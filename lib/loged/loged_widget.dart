...
class LogedWidget extends StatefulWidget {
  const LogedWidget({Key key}) : super(key: key);

  @override
  _LogedWidgetState createState() => _LogedWidgetState();
}

class _LogedWidgetState extends State<LogedWidget> {
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              final usuarioCreateData = createUsuarioRecordData(
                                ...
                                edad: displayNameController.text,
                                email: emailController.text,
                                cpassword: cpasswordController.text,
                              );
                              var usuarioRecordReference =
                                  UsuarioRecord.collection.doc();
                              await usuarioRecordReference
                                  .set(usuarioCreateData);
                              ed = UsuarioRecord.getDocumentFromData(
                                  usuarioCreateData, usuarioRecordReference);
